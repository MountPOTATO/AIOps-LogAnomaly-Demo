...
origin_log_path = "../../SelfAttentive/data/BGL_2k.log"
wordvec_path = "../../SelfAttentive/crawl-300d-2M.vec"
pattern_vec_out_path = "../../SelfAttentive/output/pattern_vec"
index_vec_out_path = "../../SelfAttentive/output/index_vec"
out_dic_path = "../../SelfAttentive/"
train_out_file_name = "../../SelfAttentive/train_seq.log"
validation_out_file_name = "../../SelfAttentive/validate_seq.log"
test_out_file_name = "../../SelfAttentive/test_seq.log"
...
N_EPOCHS = 100
CLIP = 1
MODEL_OUTPUT_PATH = "../../SelfAttentive/output/model.pt"
BATCH_SIZE = 10
PAD_IDX = 1
EMM_IDX = 0
...
if not os.path.exists("../../SelfAttentive/data"):
    os.makedirs("../../SelfAttentive/data")
if not os.path.exists("../../SelfAttentive/output"):
    os.makedirs("../../SelfAttentive/output")
